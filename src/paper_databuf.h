...
// The netthread sees more bytes than this since we can only send N_INPUTS_PER_PACKET
#define N_BYTES_PER_BLOCK_NET            (N_TIME_PER_BLOCK * N_CHAN_PER_X * ((N_INPUTS_PER_PACKET*N_INPUTS + N_INPUTS_PER_PACKET-1) / N_INPUTS_PER_PACKET))
